...
const props = defineProps(["unit_services", "search", "office_id", "unit_id"])
            ...
            <div class="col-span-3">
                <div
                    ...
                    <div class="absolute hidden group-hover:block top-0 right-0 text-white p-2 rounded ">
                        <button v-if="service.status == 1" @click="open_modal(service)" class="bg-orange-500 rounded-md p-1 mr-1">
                            <Icon icon="user" />
                        </button>
