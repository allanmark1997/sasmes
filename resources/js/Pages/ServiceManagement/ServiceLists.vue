            ...
            <div class="col-span-3">
                <div
                    ...
                    <div class="absolute hidden group-hover:block top-0 right-0 text-white p-2 rounded ">
                        <button @click="open_modal(service)" class="bg-orange-500 rounded-md p-1 mr-1">
                            <Icon icon="pencil" />
                        </button>
                        <button @click="open_modal_delete(service)" class="bg-red-500 rounded-md p-1">
                            <Icon icon="trash" />
                        </button>
                    </div>
                    ...
                    <div class="px-5 pb-5">
                        <div>
                            <h5 class="text-xl font-semibold tracking-tight text-gray-900">{{ service.name }}</h5>
