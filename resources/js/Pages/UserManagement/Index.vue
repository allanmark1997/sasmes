...
const props = defineProps(["users", "offices", "services", "search", "office", "position"])
        ...
        <div class="py-4">
                ...
                <div class="flex gap-2 ml-8">
                    <div>
                        <select v-model="position" @change="search_"
                            ...
                            <option value="" disabled>Select Client position</option>
            ...
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                    <UserLists :users="props.users" :search="props.search" :position="props.position" :office="props.office" />
                </div>
            </div>
        </div>
    </AppLayout>
