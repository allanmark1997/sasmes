...
const search_ = () => {
    router.get(
        route("client.index_details", { from: from.value, to: from.to, client_id:props.client_id })
    );
};
        ...
        <div class="py-4">
            ...
            <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden">
                    <ClientDetails :client="props.client" :from="props.from" :to="props.to" :client_id="props.client_id" :unit_services_count="props.unit_services_count" :office_visits="props.office_visits" :unit_visits="props.unit_visits" />
                </div>
            </div>
        </div>
    </AppLayout>
